      ...
      <div class="container">
          <div class="row">
              <div class="col-md-4 col-md-offset-4">
                ...
                <form action="<?php echo base_url('index.php/CHome/relembrarSenha'); ?>" method="post">
                  <input type="hidden" name="captcha">
                  <div class="form-group">
                    <label for="email">E-mail</label>
                    <input name="email" class="form-control" id="usuario" placeholder="Digite seu e-mail aqui..." required>
                  </div>
                  <button type="submit" name="recuperar" value="relembrar" class="btn btn-danger pull-right">Relembrar senha</button>
                </form>
                <div class="form-group">
