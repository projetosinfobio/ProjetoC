...
<html lang="en">
  ...
  <body>
      ...
      <ul class="nav nav-tabs">
          ...
          <a class="navbar-brand" href="#">15° Congresso de Associação Paulista de Saúde Pública</a>
        </div>
      </ul>
      <div class="container">
          <div class="row">
              <div class="col-md-4 col-md-offset-4">
                ...
                <div class="form-group">
                      ...
                      <?php 
                        if($status == 'Email enviado com sucesso!')
                          echo "A senha foi enviada para o email: ".$emailRementente."."; 
