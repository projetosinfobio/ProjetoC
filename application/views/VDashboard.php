...
<div class="panel-body">
  ...
  <div class="container" style="background-color: #F5F5F5">
    ...
    <div class="panel-heading">
      <h3>
        <center>
          <i class="fa fa-user"></i> <font size="6"> BEM-VINDO</font>
        </center>
      </h3>
    </div>
    ...
    <p>&nbsp;&nbsp;&nbsp;<u><b><font size="5">Conflitos de interesse:</font></b></u><font size="4"> Os princípios da APSP incluem o comprometimento com práticas éticas e transparentes. Alguns tipos de interesses que competem ou são conflitantes com esses princípios são barreiras para a submissão de resumos em qualquer dos formatos aceitos pelo congresso. Outros interesses, apesar de não serem barreiras, devem ser declarados como parte de um processo transparente. O preenchimento do campo existente no formulário relativo a conflito de interesses é uma pré-condição para a submissão de resumos.
    </font></p>
